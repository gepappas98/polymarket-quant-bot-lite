...
- [docs/COMPETITIVE_RESEARCH.md](docs/COMPETITIVE_RESEARCH.md) — analysis of viral "Polymarket bot" claims and which of their dashboard ideas are worth building here
